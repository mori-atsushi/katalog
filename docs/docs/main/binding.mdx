...
## Examples
<Preview
    imageUrl="/img/docs/binding.png"
    width={1080}
    height={2280} >

Use the `binding` method to add a `DataBinding` / `ViewBinding` to Katalog.
...
<Preview
    imageUrl="/img/docs/binding-match.png"
    width={1080}
    height={2280} >
...
<Preview
    imageUrl="/img/docs/binding-size.png"
    width={1080}
    height={2280} >
